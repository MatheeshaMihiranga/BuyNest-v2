...
import {
  ...
  FaCheckCircle,
  FaExclamationCircle,
} from "react-icons/fa"; // Importing icons for notifications
  ...
  const renderNotification = () => {
    ...
    const icon =
      type === "success" ? (
        ...
        <FaExclamationCircle className="text-yellow-500" size={32} />
      ) : null;
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 lg:px-20 relative">
      ...
      <div className="max-w-6xl mx-auto mt-16 border-t pt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <div className="border-b-4 border-indigo-500 py-3 text-center text-lg font-semibold">
            Description
          </div>
        ...
        <div className="mt-6 space-y-4 text-gray-600 text-lg leading-relaxed">
          <p>
            Our e-commerce platform facilitates easy product exploration and
            purchase. You can browse products, read detailed descriptions, and
            select various options before purchasing.
          </p>
          <p>
            We ensure our product pages provide all the necessary information,
            making shopping convenient and reliable for our customers.
          </p>
        </div>
      </div>
